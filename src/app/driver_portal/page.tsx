                ...
                <main className="max-w-3xl mx-auto px-4 py-6 space-y-6">
                    {!online && !currentTrip && (
                        <div className="bg-white rounded-3xl border p-6 text-center">
                            ...
                            <p className="text-gray-600 mb-6">
                                Go online to start receiving ride requests from
                                students and staff.
                            </p>
                            <button
                                onClick={goOnline}
                    ...
                    {online ? (
                        <div className="flex flex-col gap-4">
                            <h1 className="text-4xl font-bold mt-6 pl-2">
                                Your Active Rides:
                            </h1>
                            {data.activeRides.map((col) => (
                                <BookingCard key={col._id} booking={col} />
                            ))}
                        </div>
                    ) : (
                        <></>
